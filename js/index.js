...
(function () {
    var $role=$('#role'),
        ...
        whichShow=false;   // false = 第一组显示 true代表第二组显示
...
//         $tab = $character.find(".sMain .title .tab"),
//         $shishenListTab = $character.find(".shishenList .clickBtn")
//         $tab.click(function () {
...
(function () {
    ...
    for (var i = 0,length=shishenData.length; i < length; i++) {
        ...
        $div = $("<div class='shishen'>" +
            "<img src='images/index-04-shishen/"+shishenData[i].id+".png'>" +
